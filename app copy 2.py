...
def serve_saved_images(filename):
    """Serve the generated imagery from the saved_images folder."""
...
def detect_satellite():
    ...
    try:
        ...
        # Create copies to draw the red borders on the full imagery
        ...
        for cnt in contours:
            ...
            # Draw RED bounding boxes on the full images (RGB format: 255, 0, 0)
        ...
        # Save the full annotated images to the saved_images folder with a unique timestamp
